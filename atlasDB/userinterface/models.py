...
class Subject(models.Model):
    ...
    subject_name = models.CharField(max_length=25, unique=True, verbose_name='Name des Fachs')
...
class Task(models.Model):
    ...
    subject = models.ForeignKey(Subject, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name='Fach')
